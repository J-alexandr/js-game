    ...
    "6wPr": function(e, t, a) {
        ...
        var b, v, y = _, k = a("u+iS"), w = a("E1/w"), x = a("0ye6"), O = a("k1Yx"), j = a("YN+D"), S = a("woIc"), E = i.a.createElement, P = function() {
            var e = Object(S.a)().click
              ...
              , W = F.allowSound
              , K = Object(O.b)()
              , L = Object(n.a)(K, 1)[0].currentNetwork
              , q = Object(o.useState)(0)
              , G = q[0]
              , z = q[1]
              , B = Object(o.useState)("00")
              , X = (B[0],
            B[1])
              , V = Object(o.useState)("00")
              , Y = (V[0],
            V[1])
              , Q = Object(o.useState)("00")
              , Z = (Q[0],
            Q[1])
            ...
            Object(o.useEffect)((function() {
                var e = Math.floor(G / 3600)
                  , t = Math.floor((G - 60 * e) / 60)
                  , a = G - 60 * t;
                Z(e.toString().padStart(2, "0")),
                X(t.toString().padStart(2, "0")),
                Y(a.toString().padStart(2, "0")),
                G <= 0 && clearInterval(b)
            }
            ), [G]);
            return E(i.a.Fragment, null, E(f.k, null), E(f.b, {
                open: ie,
                onClose: function() {
                    return re(!1)
                }
                ...
                maxCapacity: h.ALCHEMICA_MAX_CARRY_QUANTITY,
                ...
                className: "jsx-".concat(y.__hash)
            }, " Online Players: ", D, " "), Object.keys(M || {}).map((function(e, t) {
                return E("span", {
                    key: t,
                    style: {
                        marginRight: 10,
                ...
                }, e.charAt(0).toUpperCase() + e.slice(1), ": ", M[e], "ms")
            }
            ))), "matic" === L && E("div", {
        ...
        }, A = a("o0o1"), C = a.n(A), D = a("HaE+"), H = a("a6RD"), M = a.n(H), I = a("q6t7"), N = i.a.createElement, T = M()(Object(D.a)(C.a.mark((function e() {
        ...
        }, F = a("HETB"), U = a("eXga"), W = a("XacQ"), K = a("uJKH"), L = a("2DPU"), q = a("8IY3"), G = a("ZueF"), z = {
            frameWidth: 128,
            frameHeight: 196
        }, B = {
            frameWidth: 256,
            ...
            loadSpritesheet: function() {
                ...
                v.load.spritesheet("alchemica_x3", "https://gotchi.akamaized.net/png/a30be2c9154a4ed2b51fa1b3.png", {
                    frameWidth: 31,
                    frameHeight: 39
                }),
            ...
            loadInstallation: function() {
                v.load.spritesheet("aaltar", "animations/installations/aaltar.png", B),
                v.load.spritesheet("destroyed1", "animations/installations/destroyed1.png", z),
                v.load.spritesheet("destroyed2", "animations/installations/destroyed2.png", B),
                v.load.spritesheet("destroyed5", "animations/installations/destroyed5.png", X),
                v.load.spritesheet("harv_ALPHA", "animations/installations/harv_ALPHA.png", B),
                v.load.spritesheet("harv_FOMO", "animations/installations/harv_FOMO.png", B),
                v.load.spritesheet("harv_FUD", "animations/installations/harv_FUD.png", B),
                v.load.spritesheet("harv_KEK", "animations/installations/harv_KEK.png", B),
                v.load.spritesheet("nft_large", "animations/installations/nft_large.png", B),
                v.load.spritesheet("nft_smol", "animations/installations/nft_smol.png", B),
                v.load.spritesheet("res_ALPHA", "animations/installations/res_ALPHA.png", B),
                v.load.spritesheet("res_FOMO", "animations/installations/res_FOMO.png", B),
                v.load.spritesheet("res_FUD", "animations/installations/res_FUD.png", B),
                v.load.spritesheet("res_KEK", "animations/installations/res_KEK.png", B),
                v.load.spritesheet("wall", "animations/installations/waall.png", z),
        ...
        t.default = function() {
            ...
            A.maxZoomOut)
              ...
              , me = Object(k.b)()
              , he = Object(n.a)(me, 1)[0]
              , fe = he.allowAnimatedTiles
              , ge = he.allowGotchiGlow
              , _e = he.allowInstallationAnimations
              , be = he.allowPlayerAnimation
              , ve = he.allowStarField
              , ye = he.fadeGrid
            ...
            ), ["object", typeof navigator, u, h, l, y, pe]),
            Object(o.useEffect)((function() {
                l && y && w && le(function(e, t, a, n, o, i, r, s, l, u, c, d, h, f, g) {
                    return {
                        preload: function() {
                        ...
                        init: function() {
                            ...
                            this.realmDispatch = f.realmDispatch,
                            this.phaserDispatch = f.phaserDispatch,
                            this.settingsDispatch = f.settingsDispatch,
                            this.uiDispatch = f.uiDispatch,
                            this.maxZoomOut = u,
                            this.zoom = c,
                            U.a.init(this),
                            m.a.initScene(this),
                                ...
                                return C.a.wrap((function(e) {
                                    for (; ; )
                                        ...
                                        case 0:
                                            ...
                                            Q.a.create(),
                                            W.a.initPlayer(r),
                                            K.a.initAlchemicaHUD(),
                                            this.gameSettings.allowStarField && Object(p.b)(this),
                                            U.a.socketConnect(f.realmDispatch, r);
                                        case 6:
                                        case "end":
                                            return e.stop()
                                        }
                        ...
                        update: function(e, t) {
                            ...
                            this.gameSettings.allowStarField && Object(p.l)(this, r, t)
                        }
                    }
                }(r, l, u, h, g, f, y, x, w, H, M, 0, {
                    allowAnimatedTiles: fe,
                    allowGotchiGlow: ge,
    ...
    "YN+D": function(e, t, a) {
        ...
        var y = v
          ...
          , S = function(e) {
            ...
            var q = function(e) {
                var t;
                (null === e || void 0 === e ? void 0 : null === (t = e.data) || void 0 === t ? void 0 : t.status) && e.totalClaimed && ("ERRORED" !== e.data.status ? K() : L(),
                Object(w.b)(U, {
              ...
              , G = function() {
                var e = Object(h.a)(m.a.mark((function e() {
                    var t, a, n;
                    return m.a.wrap((function(e) {
                        for (; ; )
                            ...
                            case 0:
                                return M(!0),
                                e.next = 3,
                                Object(g.d)(p, _, "installationDiamond");
                            case 3:
                                return t = e.sent,
                                e.next = 6,
                                t.installationsBalancesWithTypes(u);
                            case 6:
                                a = e.sent,
                                (n = b.a.map(a, (function(e) {
                                    var t = e.installationType
                                      , a = e.balance
                                      , n = t.name;
                                    return {
                                        id: t.installationType,
                                        name: n,
                                        quantity: Number(a),
                                        level: t.level
                                    }
            ...
            return j(s.a.Fragment, null, j(c.n, {
                title: "Inventory",
                open: t,
                onClose: a
            }, j("div", {
                ...
                className: "jsx-".concat(y.__hash)
            }, "Fetching Balances..."), j(c.l, {
                size: 2
            })), !H && A && j("div", {
                className: "jsx-".concat(y.__hash) + " inventory-grid"
            }, b.a.map(A, (function(e, t) {
                return j(c.j, {
                    key: t,
                    quantity: e.quantity,
                    installation: {
